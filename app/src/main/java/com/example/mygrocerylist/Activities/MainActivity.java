...
import com.example.mygrocerylist.Data.DataBaseHundler;
...
//                        .setAction("Action", null).show();
    ...
    private void createPopupDialog() {
        ...
        saveButtton = view.findViewById(R.id.saveButton);
    ...
    private void saveGroceryToDB(View v) {
        ...
        Log.d("Item Added ID", String.valueOf(db.getGroceries()));
